...
\begin{table}
  ...
  \label{table:hyperparameter_result}
    ...
    \end{tabular}
  \newline
  \caption{The table shows the accuracy of the adversarial examples on the tested models with different iteration numbers for both \DIFGSM and PGD attack.
          For \DIFGSM and PGD attack, the iteration numbers are both 16 and 64.
...
\begin{table}
  ...
  \label{table:defense_result}
    \begin{tabular}{|c|c|c|c|}
      \hline
      \diagbox[width=12em, height=3.7em]{Training \\adversarial examples}{testing adversarial\\examples} & FGSM & \DIFGSM & PGD \\
      \hline
      FGSM & \textbf{\defenseAccuracy{0.187}{0.767}} & \defenseAccuracy{0.014}{0.058} & \defenseAccuracy{0.019}{0.049} \\
      \DIFGSM & \defenseAccuracy{0.016}{0.286} & \textbf{\defenseAccuracy{0.53}{0.953}} & \defenseAccuracy{0.006}{0.145} \\
